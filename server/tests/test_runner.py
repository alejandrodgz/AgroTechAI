...
def main():
    ...
    if test_type == "unit":
        ...
        commands = [
            ("black --check . tests/", "Code Formatting Check"),
            ("isort --check-only . tests/", "Import Sorting Check"),
            ("flake8 . tests/", "Code Linting"),
        ]
        ...
        commands = [
            ("black . tests/", "Format Code"),
            ("isort . tests/", "Sort Imports"),
        ]
        ...
        print("Available options: unit, integration, ollama, all, coverage, lint, format")
        sys.exit(1)
